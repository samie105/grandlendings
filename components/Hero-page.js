...
export default function HeroPage() {
  ...
  return (
    <>
      <section className="w-full py-12 md:py-24 lg:py-32 relative /bg-[#111111] z-40">
          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            ...
            <div className="space-x-4">
              <Link
                href={"/loan"}
                target="_blank"
                className="inline-flex h-10 items-center justify-center rounded-md bg-white px-8 text-sm font-medium text-[#111] shadow transition-colors hover:bg-gray-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-600"
              >
                Apply Now
              </Link>
              <Link
                className="inline-flex h-10 items-center justify-center rounded-md border border-white px-8 text-sm font-medium text-white shadow transition-colors hover:bg-white hover:text-[#111] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-600"
                href="/about-us"
              >
                About Us
              </Link>
...
//              <button
//                className="rounded-lg bg-[#111111] w-2/4 mx-auto text-white font-bold px-5 py-3 text-sm"
